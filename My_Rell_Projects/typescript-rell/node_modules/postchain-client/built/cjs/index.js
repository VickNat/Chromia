...
class InvalidBlockchainRIDException extends Error {
    constructor() {
...
function retryRequest({ method, path, config, postObject }, errorCodes) {
    return __awaiter$9(this, void 0, void 0, function* () {
        let statusCode, rspBody, error;
...
class MissingPubKeyError extends Error {
    constructor() {
...
class DirectoryNodeUrlPoolException extends Error {
    constructor() {
